...
int main()
{
		...
		printf("~FLAGS TESTS~\n\n");
			...
			printf("Command:\tprintf(\"|%%-10d\\n\", 10')\n\n");
			printf("Description:\tLeft-justify within the given field width; Right justification is the default (see width sub-specifier).\n\n");
			printf("Output:\t\t|%-10d\n\n", 10);
		#endif
			...
			printf("Description:\tLeft-pads the number with zeroes (0) instead of spaces when padding is specified (see width sub-specifier).\n\n");
			printf("Output:\t\t%010d\n", 10);
		#endif
