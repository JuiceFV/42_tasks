...
static void	date_format(t_vector *frmt, long *res_date)
{
	...
	ft_vector_append(frmt, ft_itoa(res_date[3]), ft_strlen(ft_itoa(res_date[3])));
	ft_vector_append(frmt, " ", 1);
	ft_vector_append(frmt, mon[res_date[4]], ft_strlen(mon[res_date[4]]));
	ft_vector_append(frmt, " ", 1);
	ft_vector_append(frmt, ft_itoa(res_date[5]), ft_strlen(ft_itoa(res_date[5])));
}
